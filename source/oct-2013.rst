...
Yanina:
1. gmaps_area_ids debe ser \*2many (puntos necesarios para conformar area, al menos 3), 
   (gmaps_lat, gmaps_lon y many2one: gmaps_zone_id). Yanina.
2. Modulito para geolocalizar de manera precisa. (Como el de Openerp, pero los campos iran con los
...
3. Crear data demo de puntos reales. Yanina. Crear vista en lista, 
4. busqueda (group_by de zona en partner)
5. Investigar algoritmo de gmaps llamado Area para saber si un punto está dentro de un área.
7. Buscar developer key de google :) , con mi acc gmail.
